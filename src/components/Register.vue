    ...
    <el-main>
            <el-row>
              ...
              <el-card>
                ...
                <el-link :underline="false" style="float:right" v-on:click="ToLogin">已有账户？直接登录</el-link>
                </div>
                <el-row v-show="active0">
                    ...
                    <el-col :span="12">
                        <p>
                        注册成功，您可使用手机号或系统分配ID进行登录以及密码的找回。系统分配ID为XXXXXX
                        </p>
                        <el-button style="margin-top: 12px;" v-on:click="next">下一步</el-button>
                    </el-col>
                    <el-col :span="5"><div class="grid-content"></div></el-col>
...
<script>
  export default {
    ...
    methods: {
      ...
      register(){
	        if(this.userName == "" || this.userPasswd == "" || this.getUserNumber == ""){
					alert("基本信息不得为空")
				}else{
